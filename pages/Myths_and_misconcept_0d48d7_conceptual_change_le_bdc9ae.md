...
- Myths_and_misconcept_0d48d7_conceptual_change_le_bdc9ae_index
...
page_heading_title: How Learners Replace Wrong Ideas
source_count: 81
infographic_count: 3
planned_sections:
...
image: /assets/images/Myths_and_misconcept_0d48d7_conceptual_change_le_bdc9ae-overview-social.jpg
---
...
* **Ask for explanations, not just answers.** A correct multiple-choice answer can hide faulty reasoning; a short “because…” statement often reveals the model.
* **Use distractors deliberately.** Wrong options should represent common ways students think, not random errors.
* **Return to the same concept in new settings.** A learner may handle an idea in one context but revert in another.
* **Treat wrong answers as data.** Public humiliation makes students conceal their thinking; conceptual change needs students to risk making their current model explicit.
...
1. Students predict what will happen and explain why.
2. The class observes or analyses evidence that strains the existing model.
3. Students compare their initial explanation with the evidence.
4. The teacher introduces or co-constructs the better model.
5. Students use the new model to explain related cases.
...
* **They explain the failure.** Students see where the old model breaks down.
* **They provide a usable alternative.** The new idea can be applied to predictions, diagrams and new examples.
...
* identify the misconception most likely to block the next idea;
* make students’ thinking visible before teaching proceeds;
* design a task that exposes the limits of the old model;
* teach a replacement explanation clearly;
* give students repeated chances to use the new model;
* check later whether the change has endured.
